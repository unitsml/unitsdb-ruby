...
$ unitsdb check_si --entity-type=units --database=/path/to/unitsdb/data --ttl-dir=/path/to/si-framework

# Check in a specific direction only
$ unitsdb check_si --direction=from_si --database=/path/to/unitsdb/data --ttl-dir=/path/to/si-framework
...
1. Verify unreferenced TTL entries:
   * Run `unitsdb check_si_references --database=/path/to/unitsdb/data --ttl-dir=/path/to/si-framework`
...
3. Verify all references are complete:
   * Run `unitsdb check_si_references --database=/path/to/unitsdb/data --ttl-dir=/path/to/si-framework` again
   ...
   * If needed, run with the output option to automatically add missing references:
     `unitsdb check_si_references --output-updated-database=/path/to/output/dir --database=/path/to/unitsdb/data --ttl-dir=/path/to/si-framework`

The `check_si_references` command ensures every entity in the BIPM's SI Digital Reference is properly referenced in UnitsDB:
